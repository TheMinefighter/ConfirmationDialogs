...
namespace ConfirmationDialogs {
	public static class Confirmation {
		...
		{
			ConfirmationWindow window = new ConfirmationWindow(new ConfirmationTag(text ?? "The following action might be bad. Continue only if you know what you are doing!"));
			window.ShowDialog();
